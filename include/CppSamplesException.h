 ...
 */
   ...
   */
    ...
    * Gets the Line number from where this exception has been
    * generated.
    *
    * @return unsigned short The line number where the exception occured.
    *
    */
     ...
     * Gets the File Name from where this exception has been generated.
     *
